...
(
    ...
    `category_id`               INT                 NOT NULL DEFAULT 0              COMMENT '任务类别ID',
...
-- ================== script repository ==================
CREATE TABLE `xxl_job_script_file`
(
    `id`                INT NOT NULL AUTO_INCREMENT,
    `name`              VARCHAR(100) NOT NULL,
    `script_type`       VARCHAR(20) NOT NULL COMMENT 'KETTLE/HOP/PYTHON',
    `script_subtype`    VARCHAR(20) NOT NULL COMMENT 'KTR/KJB/HPL/HWF/HWL/PY',
    ...
    PRIMARY KEY (`id`),
    KEY `i_type_status` (`script_type`, `status`)
...
INSERT INTO `xxl_job_user`(`id`, `username`, `password`, `role`, `permission`, `email`)
VALUES (1, 'admin', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 1, NULL, NULL);
