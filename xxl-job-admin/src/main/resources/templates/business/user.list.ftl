				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal form" role="form" >
							...
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label">${I18n.user_email}</label>
								<div class="col-sm-8"><input type="email" class="form-control" name="email" placeholder="${I18n.system_please_input}${I18n.user_email}" maxlength="255" ></div>
							</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal form" role="form" >
							...
							<div class="form-group">
								<label for="lastname" class="col-sm-2 control-label">${I18n.user_email}</label>
								<div class="col-sm-8"><input type="email" class="form-control" name="email" maxlength="255" ></div>
							</div>
