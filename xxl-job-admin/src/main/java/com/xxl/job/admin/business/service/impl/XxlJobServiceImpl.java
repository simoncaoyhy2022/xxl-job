...
public class XxlJobServiceImpl implements XxlJobService {
	...
	@Override
	public Response<PageModel<XxlJobInfo>> pageList(int offset, int pagesize, int jobGroup, int triggerStatus, String name, String executorHandler, String author, int categoryId) {

		List<XxlJobInfo> list = xxlJobInfoMapper.pageList(offset, pagesize, jobGroup, triggerStatus, name, executorHandler, author, categoryId);
		int list_count = xxlJobInfoMapper.pageListCount(offset, pagesize, jobGroup, triggerStatus, name, executorHandler, author, categoryId);
	...
	public Response<String> update(XxlJobInfo jobInfo, LoginInfo loginInfo) {
		...
		exists_jobInfo.setCategoryId(jobInfo.getCategoryId());
