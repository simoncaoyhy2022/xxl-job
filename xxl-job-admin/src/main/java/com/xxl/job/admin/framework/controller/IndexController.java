...
public class IndexController {
	...
	private List<XxlBootResourceDTO> findResourceList(HttpServletRequest request){
		...
		List<XxlBootResourceDTO> resourceDTOList = Arrays.asList(
				...
				new XxlBootResourceDTO(2, 0, I18nUtil.getString("jobcategory") + I18nUtil.getString("system_manage"), 1, Consts.ADMIN_ROLE, "/jobcategory", " fa-tags", 5, 0, null),
				new XxlBootResourceDTO(3, 0, I18nUtil.getString("jobinfo_job") + I18nUtil.getString("system_manage"),1, "", "/jobinfo", " fa-clock-o", 2, 0, null),
				new XxlBootResourceDTO(4, 0, I18nUtil.getString("joblog_name"),1, "", "/joblog", " fa-database", 3, 0, null),
				new XxlBootResourceDTO(5, 0, I18nUtil.getString("jobgroup") + I18nUtil.getString("system_manage"),1, Consts.ADMIN_ROLE, "/jobgroup", " fa-cloud", 4, 0,null),
				new XxlBootResourceDTO(6, 0, "脚本仓库",1, Consts.ADMIN_ROLE, "/scriptfile", "fa-folder-open", 6, 0, null),
				new XxlBootResourceDTO(7, 0, I18nUtil.getString("user_name") + I18nUtil.getString("system_manage"),1, Consts.ADMIN_ROLE, "/user", "fa-users", 5, 0, null),
